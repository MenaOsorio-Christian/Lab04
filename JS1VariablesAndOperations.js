...
var seatsLeft = 10;
console.log("Step 1:  Number of Seats on a Plane " + seatsLeft);

var costOfGroceries = 150;
console.log("Step 2:  Cost of Groceries " + costOfGroceries);

var middleInitial = "A"
console.log("Step 3:  Middle Initial " + middleInitial);

var isHotOustside = true;
console.log("Step 4:  Is it Hot Outside? " + isHotOustside);

var customerName = "Chsristian";
console.log("Step 5:  First Name " + customerName);

var streetAddress = "2245 Johnson St, Salt Lake City, UT";
 ...
 * */
    ...
    console.log('Remove Plane Seats: 2')
//	A customer booked 2 plane seats. Remove 2 seats from the available seats variable
//  ↓ YOUR CODE HERE ↓
console.log("New seats available " + (seatsLeft - 2))

    console.log('Buy a Candy Bar: $2.15')
//	Impulse candy bar purchase! Add 2.15 to the grocery total
//  ↓ YOUR CODE HERE ↓
console.log("Item add to grocery total $" + (costOfGroceries + 2.15))

    console.log('Fix a Birth Certificate: B')
//	A birth certificate was printed incorrectly, change the middle initial to something elsecon
//  ↓ YOUR CODE HERE ↓
var middleInitial = "B";
...
//  ↓ YOUR CODE HERE ↓
isHotOustside = !isHotOustside;
console.log("New temperature " + isHotOustside)
...
//  ↓ YOUR CODE HERE ↓
console.log("hello, this is: " + fullName + " He lives at: " + streetAddress)
